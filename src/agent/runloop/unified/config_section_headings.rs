...
static SECTION_HEADINGS: &[(&str, &str, &str)] = &[
    ...
    ("agent", "Agent Defaults", "Primary model, prompt, and chat behaviour."),
    ...
    ("auth.openrouter", "OpenRouter OAuth", "Browser login flow and token refresh behaviour."),
    ...
    ("optimization.llm_client", "LLM Client", "HTTP client behaviour for model requests."),
    ...
    ("optimization.tool_registry", "Tool Registry", "Startup and lookup behaviour for tool metadata."),
    ("output_style", "Output Style", "Formatting and readability preferences."),
    ("permissions", "Permissions", "Default approval and trust behaviour."),
    ("prompt_cache", "Prompt Cache", "Reuse prompts to cut duplicate provider work."),
    ("prompt_cache.providers", "Prompt Cache Providers", "Provider-specific prompt cache behaviour."),
    ...
    ("skills", "Skills", "Skill discovery, rendering, and loading behaviour."),
    ...
    ("tools", "Tool Defaults", "Loop limits and default tool behaviour."),
    ...
    ("ui", "Interface", "Appearance, layout, and transcript behaviour."),
    ...
    ("ui.status_line", "Status Line", "Bottom status bar content and refresh behaviour."),
];
