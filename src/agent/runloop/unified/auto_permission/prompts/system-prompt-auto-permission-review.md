...
6. **Avoid data exfiltration** - Post messages to chat platforms or work tickets only when the user directed that destination. Do not share secrets unless the user explicitly authorized both the specific secret and destination.
