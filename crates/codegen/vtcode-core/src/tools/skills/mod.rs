...
"#,
    ...
    ast_grep_query_tests! {
        ...
        list_skills_discovers_bundled_ast_grep_by_search_rewrite_lint_analyse_query => "search rewrite lint analyse",
        list_skills_discovers_bundled_ast_grep_by_search_rewrite_lint_analyse_legacy_spelling_query => "search rewrite lint analyze",
