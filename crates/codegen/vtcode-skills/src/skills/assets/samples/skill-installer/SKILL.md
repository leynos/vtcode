...
- List curated skills when the user asks what is available, or if the user
    uses this skill without specifying what to do.
...
- After installation, the skill is immediately available in the current
    session.
