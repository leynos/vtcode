...
Inspired by [caniuse.rs](https://caniuse.rs), this document tracks feature
availability and platform support across the VT Code ecosystem.
...
**Legend:** Yes = Fully Supported | Partial = Partial Support | No = Not
Supported
...
All VT Code crates require Rust 1.88 or later due to dependencies (ratatui
0.30, darling 0.23, sysinfo 0.37, zip 8.1).
...
1. **File Permissions**: Unix permission model doesn't map cleanly to Windows
   ACLs
2. **PTY Support**: Windows ConPTY has different behavior than Unix PTYs
3. **Signal Handling**: Windows has limited signal support (Ctrl+C, Ctrl+Break
   only)
4. **Keyring Fallback**: Auto-fallback from keyring to file storage when
   unavailable
...
- [rust-lang.github.io/rfcs](https://rust-lang.github.io/rfcs) - Rust RFCs and
  feature tracking

______________________________________________________________________

*Last updated: 2026-06-28* *VT Code Version: 0.133.21*
