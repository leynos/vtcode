...
Full mapping of all 19 Zen of Python principles to VT Code controls, checks,
...
- Strategy: additive. This document complements `CORE_BELIEFS.md` and
...
- This alignment does not replace `ARCHITECTURAL_INVARIANTS.md`; it maps
  principles to controls.
