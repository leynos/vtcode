...
| `merge-gateway` | `MERGE_GATEWAY_API_KEY` | –                | Required for native Merge Responses/catalogue access; set `MERGE_GATEWAY_BASE_URL` for a proxy or explicit `/v1/openai` legacy compatibility. |
