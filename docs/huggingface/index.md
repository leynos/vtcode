...
A curated collection of tools and integrations built to work with Hugging Face
Inference Providers.
...
This directory contains documentation for tools that integrate with Hugging
Face Inference Providers to provide enhanced functionality for AI-powered
workflows.
...
- v Work with Hugging Face Inference Providers (Inference API or Dedicated
  Endpoints)
...
2. **Fork the repository** at
   [github.com/huggingface/hub-docs](https://github.com/huggingface/hub-docs)
3. **Update this index** (`docs/inference-providers/integrations/index.md`) to
   add your tool with a link to your integration docs
...
1. Create a [Hugging Face account](https://huggingface.co/join) if you don't
   have one
...
- Monitor your API usage on the
  [Hugging Face dashboard](https://huggingface.co/account)
...
- **GitHub Discussions**:
  [HF Hub-Docs](https://github.com/huggingface/hub-docs/discussions)
- **Hugging Face Forums**:
  [forums.huggingface.co](https://forums.huggingface.co)
...
- Share your feedback on
  [Hugging Face discussions](https://github.com/huggingface/hub-docs/discussions)
